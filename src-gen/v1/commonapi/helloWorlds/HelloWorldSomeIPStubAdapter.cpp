 ...
 */
#include <v1/commonapi/helloWorlds/HelloWorldSomeIPStubAdapter.hpp>
#include <v1/commonapi/helloWorlds/HelloWorld.hpp>
...
std::shared_ptr<CommonAPI::SomeIP::StubAdapter> createHelloWorldSomeIPStubAdapter(
    ...
    return std::make_shared< HelloWorldSomeIPStubAdapter<::v1::commonapi::helloWorlds::HelloWorldStub>>(_address, _connection, _stub);
}
