...
*/
#ifndef V1_COMMONAPI_HELLOWORLDS_Hello_World_STUB_DEFAULT_HPP_
#define V1_COMMONAPI_HELLOWORLDS_Hello_World_STUB_DEFAULT_HPP_
...
#endif // V1_COMMONAPI_HELLOWORLDS_Hello_World_STUB_DEFAULT
